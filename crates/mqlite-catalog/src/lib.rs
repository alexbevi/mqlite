...
pub use catalog::{
    ...
    apply_index_specs, build_index_specs, default_index_name, drop_indexes_from_collection,
    index_key_for_document, validate_collection_indexes, validate_drop_indexes,
};
