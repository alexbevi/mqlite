...
- Aggregation expression smoke coverage for every currently supported public expression operator listed in `capabilities/mqlite/gap-analysis.generated.md`, including arithmetic, comparison, boolean, membership, and null-coalescing cases.
